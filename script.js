...
var filler = document.getElementById("colorImg");
...
function change1() {
  ...
  p3.innerText =
    "Created the branding, designs, website and content. Product development, formula creation, quality control.";
  p4.innerText =
    "Managed a team of 8 people active in marketing, sales and manufacturing.";
...
function change2() {
  p1.innerText =
    "NGO creating and distributing innovative kit face masks during the pandemic.";
  p2.innerText = "Developed the product and the production line. ";
  p3.innerText =
    "Formed the financial plan, oversaw the company’s bank accounts. Handled relationship with investors and donors.";
  p4.innerText =
    "Ensured the presentation in front of clients. Liaised with the suppliers and controlled the orders. ";
...
function change3() {
  p1.innerText =
    "After school start up offering families supervised DIY classes.";
  p2.innerText = "Conceptualized the curriculums.";
  p3.innerText =
    "Coordinated a team of teachers, and lead large group of students.";
  p4.innerText = "";
  p5.innerText = "";
...
function change4() {
  ...
  p2.innerText =
    "Taught a group of 23+ students in diverse cultures, languages and countries.";
  p3.innerText =
    "Installed positive classroom management strategies that promoted time management, responsibility and teamwork.";
  p4.innerText =
    "Provided individual and group support to students using methods such as direct instruction and learning centers to motivate and instill an enthusiasm for learning.";
